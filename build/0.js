...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wallet__ = __webpack_require__(886);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_clipboard__ = __webpack_require__(378);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
            ...
            this_1.cryptocompareService.getRateCrypto(trigram.toLowerCase())
                ...
                _this.walletService.getBalanceWallets(_this.walletService.wallets[trigram.toLowerCase()].address, trigram.toLowerCase()).takeWhile(function () { return _this.alive; }).subscribe(function (value) {
                    _this.wallets.push({
                        ...
                        name: trigram.toLowerCase() == 'btc' ? 'Bitcoin' : 'Ethereum',
