...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__wallet__ = __webpack_require__(1739);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_qrcode2__ = __webpack_require__(1685);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_clipboard__ = __webpack_require__(693);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WalletPage = (function () {
    function WalletPage(cryptocompareService, navCtrl, walletService, loadingCtrl, clipboard, toastCtrl) {
    ...
    WalletPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        var _loop_1 = function (trigram) {
            this_1.cryptocompareService.getRateCrypto(trigram.toLowerCase())
                .takeWhile(function () { return _this.alive; })
                .subscribe(function (data) {
                _this.rates[trigram] = data;
                _this.walletService.getBalanceWallets(_this.walletService.wallets[trigram.toLowerCase()].address, trigram.toLowerCase()).takeWhile(function () { return _this.alive; }).subscribe(function (value) {
                    _this.wallets.push({
                        icon: 'assets/img/' + trigram.toLowerCase() + '-avatar.png',
                        name: trigram.toLowerCase() == 'btc' ? 'Bitcoin' : trigram.toLowerCase() == 'eth' ? 'Ethereum' : 'Neo',
                        trigram: trigram.toLowerCase(),
                        address: _this.walletService.wallets[trigram.toLowerCase()].address,
                        public: _this.walletService.wallets[trigram.toLowerCase()].public,
                        private: _this.walletService.wallets[trigram.toLowerCase()].private,
                        amount: value,
                        rates: _this.rates[trigram],
                        nameWalletJsonEthOrBtcName: _this.walletService.wallets[trigram.toLowerCase()].nameWalletJsonEthOrBtcName
                    });
    ...
    WalletPage.prototype.ionViewWillLeave = function () {
        this.alive = false;
    };
    WalletPage.prototype.openItem = function (wallet) {
        this.navCtrl.push('WalletDetailPage', {
            wallet: wallet
        });
    };
    WalletPage.prototype.send = function (wallet) {
        this.navCtrl.push('ActionWalletPage', {
            wallet: wallet,
            action: 'send'
        });
    };
    WalletPage.prototype.request = function (wallet) {
        this.navCtrl.push('ActionWalletPage', {
            wallet: wallet,
            action: 'request'
        });
    };
    WalletPage.prototype.copy = function (wallet) {
        var _this = this;
        this.clipboard.copy(wallet.address).then(function (value) {
            _this.toastCtrl.create({
                message: 'Your ' + wallet.trigram.toUpperCase() + ' address has been copied in your clipboard. \nSend fund to this ' + wallet.trigram.toUpperCase() + ' address',
                duration: 3000,
                position: 'bottom'
            }).present();
        });
...
WalletPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-wallet',template:/*ion-inline-start:"D:\ivpay2\src\pages\wallet\wallet.html"*/'<ion-header >\n\n  <ion-navbar color="primary" no-border-bottom>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>\n      Wallets\n    </ion-title>\n  </ion-navbar>\n\n  <ion-toolbar no-border-top>\n    <ion-segment [(ngModel)]="type">\n      <ion-segment-button value="eth">\n        ETH\n      </ion-segment-button>\n      <ion-segment-button value="btc">\n        BTC\n      </ion-segment-button>\n      <ion-segment-button value="neo">\n        NEO\n      </ion-segment-button>\n    </ion-segment>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding>\n  <div [ngSwitch]="type">\n\n    <ion-segment [(ngModel)]="typeNeo" *ngSwitchCase="\'neo\'">\n      <ion-segment-button value="neo">\n        NEO\n      </ion-segment-button>\n      <ion-segment-button value="gas">\n        GAS\n      </ion-segment-button>\n    </ion-segment>\n\n    <div *ngIf="type != \'neo\'">\n      <div *ngFor="let item of wallets">\n\n        <ion-list *ngSwitchCase="item.trigram.toLowerCase()">\n          <ion-item>\n            <ion-avatar item-start>\n              <img [src]="item.icon">\n            </ion-avatar>\n            <h2>{{item.name}}</h2>\n          </ion-item>\n\n          <ion-row>\n            <ion-col>\n              <ngx-qrcode [qrc-value]="item.address"></ngx-qrcode>\n            </ion-col>\n            <ion-col>\n              <h2>{{item.trigram.toUpperCase()}}</h2>\n              <h2>{{item.amount}}</h2>\n              <div *ngFor="let key of currencies(item.rates)">\n                <p>{{ key + \' : \' + item.rates[key] * item.amount}}</p>\n              </div>\n            </ion-col>\n\n          </ion-row>\n\n\n          <ion-card-content>\n            <p center text-center>Your {{item.name}} Address</p>\n            <p center text-center>{{item.address}}</p>\n          </ion-card-content>\n\n          <ion-row>\n            <ion-col text-center>\n              <button ion-button icon-only (click)="copy(item)">\n                <ion-icon name="add"></ion-icon>\n              </button>\n              <p>Deposit</p>\n            </ion-col>\n            <ion-col text-center>\n              <button ion-button icon-only (click)="send(item)">\n                <ion-icon name="md-arrow-round-up"></ion-icon>\n              </button>\n              <p>Send</p>\n            </ion-col>\n            <ion-col text-center>\n              <button ion-button icon-only (click)="request(item)">\n                <ion-icon name="md-arrow-round-down"></ion-icon>\n              </button>\n              <p>Request</p>\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col center text-center>\n              <button ion-button color="primary" clear small icon-start (click)="openItem(item)">\n                <ion-icon name=\'md-barcode\'></ion-icon>\n                Transactions\n              </button>\n            </ion-col>\n          </ion-row>\n        </ion-list>\n      </div>\n    </div>\n\n\n    <div [ngSwitch]="typeNeo" *ngIf="type == \'neo\'">\n\n      <div *ngFor="let item of wallets">\n\n        <ion-list *ngSwitchCase="item.trigram.toLowerCase()">\n          <ion-item>\n            <ion-avatar item-start>\n              <img [src]="item.icon">\n            </ion-avatar>\n            <h2>{{item.name}}</h2>\n          </ion-item>\n\n          <ion-row>\n            <ion-col>\n              <ngx-qrcode [qrc-value]="item.address"></ngx-qrcode>\n            </ion-col>\n            <ion-col>\n              <h2>{{item.trigram.toUpperCase()}}</h2>\n              <h2>{{item.amount}}</h2>\n              <div *ngFor="let key of currencies(item.rates)">\n                <p>{{ key + \' : \' + item.rates[key] * item.amount}}</p>\n              </div>\n            </ion-col>\n\n          </ion-row>\n\n\n          <ion-card-content>\n            <p center text-center>Your {{item.name}} Address</p>\n            <p center text-center>{{item.address}}</p>\n          </ion-card-content>\n\n          <ion-row>\n            <ion-col text-center>\n              <button ion-button icon-only (click)="copy(item)">\n                <ion-icon name="add"></ion-icon>\n              </button>\n              <p>Deposit</p>\n            </ion-col>\n            <ion-col text-center>\n              <button ion-button icon-only (click)="send(item)">\n                <ion-icon name="md-arrow-round-up"></ion-icon>\n              </button>\n              <p>Send</p>\n            </ion-col>\n            <ion-col text-center>\n              <button ion-button icon-only (click)="request(item)">\n                <ion-icon name="md-arrow-round-down"></ion-icon>\n              </button>\n              <p>Request</p>\n            </ion-col>\n          </ion-row>\n\n          <ion-row>\n            <ion-col center text-center>\n              <button ion-button color="primary" clear small icon-start (click)="openItem(item)">\n                <ion-icon name=\'md-barcode\'></ion-icon>\n                Transactions\n              </button>\n            </ion-col>\n          </ion-row>\n        </ion-list>\n      </div>\n    </div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"D:\ivpay2\src\pages\wallet\wallet.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__providers_cryptocompare_service__["a" /* CryptocompareService */],
