...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pay__ = __webpack_require__(1723);
...
var PayPage = (function () {
    function PayPage(modalCtrl, barcodeScanner, cryptocompareService, navCtrl, userService, walletService, params, loadingCtrl, alertCtrl) {
    ...
    PayPage.prototype.switch = function () {
        this.isFiat = !this.isFiat;
    };
    PayPage.prototype.updateCryptoAmount = function () {
    ...
    PayPage.prototype.displayInputAddress = function () {
        this.displayInput = true;
    };
    PayPage.prototype.scanCode = function () {
        var _this = this;
    ...
    PayPage.prototype.next = function () {
        ...
        this.walletService.getBalanceWallets(this.address, this.trigram)
            .takeWhile(function () { return _this.alive; })
    ...
    PayPage.prototype.checkForm = function () {
