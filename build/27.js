...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__homev1__ = __webpack_require__(863);
...
LoginListPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_0__homev1__["a" /* Homev1Page */]),
...
var Homev1Page = (function () {
    function Homev1Page(mapServiceProvider, renderer, loadingCtrl, userService, articleService, platform, geolocation, alertCtrl, navCtrl) {
    ...
    Homev1Page.prototype.ionViewWillEnter = function () {
        var _this = this;
    ...
    Homev1Page.prototype.ionViewWillLeave = function () {
        this.alive = false;
    ...
    Homev1Page.prototype.displaySearchBar = function () {
        var _this = this;
    ...
    Homev1Page.prototype.loadMapNative = function () {
        var _this = this;
    ...
    Homev1Page.prototype.showPage = function (page) {
        this.navCtrl.push(page);
    };
    Homev1Page.prototype.loadServiceNative = function () {
        var _this = this;
    ...
    Homev1Page.prototype.loadFiatPosition = function () {
        var _this = this;
    ...
    Homev1Page.prototype.loadService = function () {
        var _this = this;
    ...
    Homev1Page.prototype.findService = function (text1) {
    ...
    Homev1Page.prototype.seeDetails = function (item) {
        this.navCtrl.push('ArticlePage', { article: item, key: item.$key });
    };
    Homev1Page.prototype.seeDetailsService = function (item) {
        this.navCtrl.push('ServicePage', { service: item, key: item.$key });
    };
    Homev1Page.prototype.loadMap = function () {
        var _this = this;
    ...
    Homev1Page.prototype.addPositionFiat = function (lat, lng, profil, uid) {
        this.markers.push({
            lat: lat,
            lng: lng,
            draggable: false,
    ...
    Homev1Page.prototype.addMarkerService = function (service) {
        this.markers.push({
    ...
    Homev1Page.prototype.contact = function (profil, uid) {
    ...
    Homev1Page.prototype.getItems = function (ev) {
...
], Homev1Page.prototype, "mapElement", void 0);
__decorate([
