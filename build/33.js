...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modal_article_action__ = __webpack_require__(1708);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_transaction_service__ = __webpack_require__(684);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_user_service__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_cryptocompare_service__ = __webpack_require__(681);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_article_service__ = __webpack_require__(238);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
                                ...
                                handler: function (data) {
                                    ...
                                    _this.walletService.getWallets(_this.article.uid).takeWhile(function () { return _this.alive; }).subscribe(function (content) {
                                        ...
                                        if (!_this.isInventory) {
                                            _this.article.address = _this.address;
                                            ...
                                            _this.article.address = _this.article.latitude + "," + _this.article.longitude;
