...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__request__ = __webpack_require__(1726);
...
PayPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_3__request__["a" /* RequestPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__request__["a" /* RequestPage */]),
...
var RequestPage = (function () {
    function RequestPage(modalCtrl, cryptocompareService, navCtrl, userService, walletService, requestService, params, loadingCtrl, alertCtrl) {
        var _this = this;
    ...
    RequestPage.prototype.switch = function () {
        this.isFiat = !this.isFiat;
    };
    RequestPage.prototype.updateCryptoAmount = function () {
        this.amountCrypto = this.amountFiat / this.rate;
    };
    RequestPage.prototype.updateFiatAmount = function () {
        this.amountFiat = this.amountCrypto * this.rate;
    };
    RequestPage.prototype.displayInputAddress = function () {
        this.displayInput = true;
    };
    RequestPage.prototype.generateRequest = function () {
        if (!this.checkForm()) {
            return;
        }
    ...
    RequestPage.prototype.checkForm = function () {
