...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scan__ = __webpack_require__(1728);
...
var ScanPage = (function () {
    function ScanPage(articleService, navCtrl, requestService, barcodeScanner, platform, alertCtrl, params) {
        ...
        //     alert.present();
        // }
        this.scannedCode = this.params.get("code");
    }
    ...
    ScanPage.prototype.continue = function () {
        var _this = this;
        if (this.scannedCode.indexOf('neoplace') >= 0) {
            this.requestService.processRequest(this.scannedCode);
        }
        else {
            this.articleService.getInventory(this.scannedCode)
                .takeWhile(function () { return _this.alive; })
                .subscribe(function (data) {
                if (data.uid) {
                    _this.navCtrl.push('ArticlePage', { article: data, mine: true, isInventory: true });
                }
                else {
                    var alert1 = _this.alertCtrl.create({
                        title: 'Error',
                        subTitle: 'No valid code scanned',
                        buttons: ['Close']
                    });
                    alert1.present();
                }
...
ScanPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-scan',template:/*ion-inline-start:"D:\ivpay2\src\pages\scan\scan.html"*/'<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Scan</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n    Scan Qr Code or Bar Code :\n\n    <br>\n\n    <button ion-button block color="primary" (click)="scanCode()">Scan Code</button>\n\n    <br>\n\n    Qr Code scanned :<br>\n\n    <ion-card-content text-center center *ngIf="scannedCode">\n\n      <ngx-qrcode [qrc-value]="scannedCode"></ngx-qrcode>\n\n    </ion-card-content>\n\n\n\n</ion-content>\n\n\n\n<ion-footer *ngIf="scannedCode">\n\n  <button ion-button block color="secondary" (click)="continue()">Continue</button>\n\n</ion-footer>\n\n'/*ion-inline-end:"D:\ivpay2\src\pages\scan\scan.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__providers_article_service__["a" /* ArticleService */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_4__providers_request_service__["a" /* RequestService */],
